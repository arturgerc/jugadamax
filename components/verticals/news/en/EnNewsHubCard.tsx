...
/**
 * English news card for hub directory and featured rows.
 */
export function EnNewsHubCard({
  card,
  featured = false,
  priority = false,
}: {
  ...
  return (
    ...
    >
      <EnNewsCoverVisual card={card} featured={featured} priority={priority} />
