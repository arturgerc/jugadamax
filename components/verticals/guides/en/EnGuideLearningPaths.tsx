...
import { EN_GUIDE_LEARNING_PATHS } from "@/components/verticals/guides/en/en-guide-hub-config";
...
/**
 * “Where to start” educational journey cards for /en/guides.
 */
export function EnGuideLearningPaths() {
  return (
    <section
      id="where-to-start"
    ...
    >
      <div className="max-w-3xl space-y-1">
        ...
        <p className="text-sm text-muted-foreground sm:text-base">
          Three learning paths depending on what you want to understand first. Paths may lead to a
          guide, ranking or research page — each destination is labelled honestly.
        </p>
      </div>
      <ul className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-4">
        {EN_GUIDE_LEARNING_PATHS.map((path, i) => {
