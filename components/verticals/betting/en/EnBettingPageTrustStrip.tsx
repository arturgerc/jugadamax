...
/**
 * Compact affiliate + responsible gambling strip for /en/betting.
 */
export function EnBettingPageTrustStrip({ className }: { className?: string }) {
  return (
    <div
      role="note"
      className={cn(
    ...
    >
      ...
      <p className="min-w-0 flex-1 text-[0.75rem] leading-snug text-muted-foreground sm:text-sm sm:leading-relaxed">
        <span className="sm:hidden">
          Affiliate links possible. Editorial opinions; verify terms.{" "}
        </span>
        <span className="hidden sm:inline">
          18+ · Some links are affiliate. JugadaMax may earn a commission at no extra cost to you.
          Scores are editorial opinions and do not guarantee odds, payments, licences or outcomes.
