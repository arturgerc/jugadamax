...
/**
 * Compact two-column hero for /en/bonuses — mirrors Spanish BonusPageHero geometry.
 */
export function EnBonusPageHero() {
  return (
      ...
      <div className="relative grid gap-4 p-5 sm:p-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center lg:gap-8 lg:p-8">
        <div className="space-y-3">
          ...
          <h1 className="text-[1.75rem] font-bold leading-tight tracking-tight text-foreground sm:text-[2.1rem] lg:text-[2.3rem]">
            Casino Bonuses & Promotions: Terms, Wagering and Limits
          </h1>
          <p className="max-w-2xl text-base leading-relaxed text-muted-foreground">
            Compare selected casino, crypto and sportsbook promotions for English-speaking readers.
            Review minimum deposits, wagering, eligible games, expiry, limits, verification and
            market restrictions before opting in.
          </p>
          ...
          <div className="flex flex-wrap gap-2 pt-0.5">
            <TrackedLink
              ...
              section="hero"
              destination="#featured-promotions"
        ...
        <aside
          aria-labelledby="en-bonus-hero-check-heading"
        ...
        >
          ...
          <div className="relative">
            <h2
              id="en-bonus-hero-check-heading"
            ...
            <p className="mt-2 text-[0.65rem] leading-snug text-muted-foreground">
              Always confirm the live promotion and terms on the operator site.
            </p>
          </div>
        </aside>
      </div>
