...
/**
 * Compact featured bonus card — English labels, Spanish geometry.
 */
export function EnBonusFeaturedCard({
  row,
  position,
  featured = false,
}: {
    ...
    >
      ...
      <div className="relative flex flex-wrap items-center justify-between gap-1.5">
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          >
            {featured ? "Featured pick" : "Featured offer"}
          </span>
          {row.badge ? (
        ...
        <div className={BONUS_SURFACES.dataCell}>
          ...
          <dd className="mt-0.5">
            {row.promoCode ? (
              ...
              <span className="font-medium text-foreground">Not published</span>
            )}
          </dd>
        </div>
      </dl>
