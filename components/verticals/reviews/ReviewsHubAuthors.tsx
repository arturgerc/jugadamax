...
/** Reviews Hub order: Redacción first, then Arturs. */
function orderReviewHubAuthors(authors: Author[]): Author[] {
...
/**
 * Authors and editorial team for Reviews Hub — profiles + LinkedIn identity links.
 */
export function ReviewsHubAuthors() {
  const authors = orderReviewHubAuthors(getAuthors());

  return (
    <section
      id="autores-editoriales"
      aria-labelledby="autores-reseñas-heading"
    ...
    >
      <div className="max-w-3xl space-y-1">
        <h2
          id="autores-reseñas-heading"
          className="text-xl font-bold tracking-tight text-foreground sm:text-2xl lg:text-[1.65rem]"
        >
          Autores y equipo editorial
        </h2>
        <p className="text-sm text-muted-foreground sm:text-base">
          Las reseñas llevan atribución clara. LinkedIn se usa para identidad y
          distribución, no como fuente factual de operadores o calificaciones.
        </p>
      </div>
