...
/**
 * Compact two-column Reviews Hub hero — editorial, no affiliate CTA.
 */
export function ReviewsHubHero() {
  return (
    <header className="relative mb-7 overflow-hidden rounded-2xl border border-white/12 bg-gradient-to-br from-[#10182a] via-[#0A1931] to-[#0c1424] shadow-[0_0_40px_-24px_rgba(255,184,0,0.3)] sm:mb-10">
      ...
      <div className="relative grid gap-4 p-5 sm:p-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center lg:gap-8 lg:p-8">
        <div className="space-y-3">
          ...
          <ul className="flex flex-wrap gap-2" aria-label="Enfoque del hub de reseñas">
          ...
          <div className="flex flex-wrap gap-2 pt-0.5">
            ...
            >
              Cómo leemos las notas
            </Link>
          </div>
        </div>

        <aside
          aria-labelledby="reviews-hero-cover-heading"
        ...
        >
          <h2
            id="reviews-hero-cover-heading"
            className="text-sm font-semibold tracking-tight text-foreground"
          >
            Qué incluye cada reseña
          </h2>
          ...
          <p className="mt-2 text-[0.65rem] leading-snug text-muted-foreground">
            Opinión editorial de JugadaMax. No es un promedio de usuarios ni una
            garantía de resultados, licencia o retiros.
          </p>
        </aside>
      </div>
    </header>
