...
/**
 * Compact editorial trust strip for Reviews Hub V2.
 */
export function ReviewsHubTrustStrip({ className }: { className?: string }) {
  return (
    <div
      role="note"
      className={cn(
    ...
    >
      ...
      <p className="min-w-0 flex-1 text-[0.8125rem] leading-snug text-muted-foreground sm:text-sm sm:leading-relaxed">
        Notas de JugadaMax con autores identificados y fechas reales. Este directorio
        no incluye botones de registro ni CTAs de afiliado: enlaza solo a reseñas
        internas.{" "}
        <Link
          href="/como-evaluamos"
