...
/**
 * Compact two-column English Reviews Hub hero — editorial, no affiliate CTA.
 */
export function EnReviewsHero() {
  return (
      ...
      <div className="relative grid gap-4 p-5 sm:p-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center lg:gap-8 lg:p-8">
        <div className="space-y-3">
          ...
          <p className="max-w-2xl text-base leading-relaxed text-muted-foreground">
            Compare JugadaMax editorial reviews of crypto casinos, fiat and multi-currency
            operators, privacy-focused casinos and sportsbooks. Each review covers editorial
            scoring, payments, verification, strengths, drawbacks and real publication dates.
          </p>
          <ul className="flex flex-wrap gap-2" aria-label="Reviews hub focus">
        ...
        <aside
          aria-labelledby="en-reviews-hero-cover-heading"
        ...
        >
          <h2
            id="en-reviews-hero-cover-heading"
          ...
          <p className="mt-2 text-[0.65rem] leading-snug text-muted-foreground">
            JugadaMax ratings are editorial opinions, not aggregated user scores or guaranteed
            outcomes.
          </p>
        </aside>
      </div>
