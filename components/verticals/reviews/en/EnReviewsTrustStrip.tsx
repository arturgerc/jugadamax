...
/**
 * Compact editorial trust strip for English Reviews Hub V2.
 */
export function EnReviewsTrustStrip({ className }: { className?: string }) {
  return (
    <div
      role="note"
      className={cn(
    ...
    >
      ...
      <p className="min-w-0 flex-1 text-[0.8125rem] leading-snug text-muted-foreground sm:text-sm sm:leading-relaxed">
        JugadaMax reviews use identified authors, real publication dates and documented editorial
        criteria. This directory contains no registration buttons or operator CTAs; it links only to
