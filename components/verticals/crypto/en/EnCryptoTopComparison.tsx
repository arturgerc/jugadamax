...
function resolveRows() {
  return EN_CRYPTO_TOP_SIX.flatMap((entry) => {
 ...
 */
export function EnCryptoTopComparison() {
  ...
  return (
    <section
      ...
      aria-labelledby="en-comparativa-crypto-heading"
      className="mb-7 scroll-mt-24 sm:mb-10 lg:mb-12"
    >
      <div className="max-w-3xl space-y-1">
        <h2
          id="en-comparativa-crypto-heading"
          className="text-xl font-bold tracking-tight text-foreground sm:text-2xl"
        >
          Quick crypto casino comparison
        </h2>
        <p className="text-sm text-muted-foreground sm:text-base">
          Snapshot of the main selection. Availability, KYC, networks, limits and withdrawals depend
          on each operator and your jurisdiction.
        </p>
      </div>
      ...
      <details className="group mt-4 rounded-xl border border-white/10 bg-[#111417]/60 open:border-primary/20 md:hidden">
        ...
        >
          <span className="flex min-w-0 items-center gap-2">
            <span className="truncate">View quick comparison of the 6 casinos</span>
