  ...
  return (
    ...
    >
      ...
      <p className="min-w-0 flex-1 text-[0.8125rem] leading-snug text-muted-foreground sm:text-sm sm:leading-relaxed">
        Algunos enlaces son afiliados. JugadaMax puede recibir una comisión sin costo adicional para
        ti. Las puntuaciones son opiniones editoriales y no garantizan pagos, licencias ni
        resultados. Verifica disponibilidad y términos.{" "}
        <Link
