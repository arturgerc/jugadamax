...
const QUICK_LINKS = [
  ...
  { label: "Guías", href: "#guias-crypto-mexico" },
] as const;
...
/**
 * Compact crypto-page hero aligned with HomepageHeroV3.
 */
export function CryptoPageHero() {
  return (
      ...
      <div className="relative grid gap-4 p-5 sm:p-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center lg:gap-8 lg:p-8">
        <div className="space-y-3">
          ...
          <p className="max-w-2xl text-base leading-relaxed text-muted-foreground">
            ...
            pagos, juegos, promociones y condiciones publicadas por cada operador.
          </p>
        ...
        >
          ...
          <p className="mt-2 text-[0.65rem] leading-snug text-muted-foreground">
            Confirma siempre disponibilidad y términos en el operador.{" "}
            <Link
              href="/como-evaluamos"
