...
import type { FiatCardTheme } from "@/components/verticals/fiat/fiat-page-config";
import type { ImageRef } from "@/types/content";
import { cn } from "@/lib/utils";

export type FiatTopCasinoCardProps = {
  operatorId: string;
  name: string;
  badge: string;
  purpose: string;
...
/**
 * Compact TOP fiat recommendation card for /casinos-fiat.
 */
export function FiatTopCasinoCard({
  operatorId,
  name,
  badge,
  purpose,
