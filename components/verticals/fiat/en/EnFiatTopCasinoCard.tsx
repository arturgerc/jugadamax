...
import type { EnFiatCardTheme } from "@/components/verticals/fiat/en/en-fiat-page-config";
import type { ImageRef } from "@/types/content";
import { cn } from "@/lib/utils";

export type EnFiatTopCasinoCardProps = {
  operatorId: string;
  name: string;
  badge: string;
  purpose: string;
...
> = {
  ...
  xonbet: {
    card: "border-sky-500/30 bg-gradient-to-b from-[#071528] via-[#0a1a33] to-[#0A1931]",
    badge: "border-sky-400/40 bg-sky-500/12 text-sky-200",
    purpose: "text-sky-300",
    accent: "text-sky-300",
  },
  slotoro: {
    card: "border-violet-500/25 bg-gradient-to-b from-[#14102a] via-[#12182c] to-[#0A1931]",
    badge: "border-violet-400/35 bg-violet-500/10 text-violet-200",
    purpose: "text-violet-300/90",
...
/**
 * Compact TOP fiat recommendation card for /en/casinos-fiat.
 */
export function EnFiatTopCasinoCard({
  operatorId,
  name,
  badge,
  purpose,
