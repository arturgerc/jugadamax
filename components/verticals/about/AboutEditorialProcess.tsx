...
import { ABOUT_PROCESS_STEPS } from "@/components/verticals/about/about-config";
import { cn, focusRing } from "@/lib/utils";

export function AboutEditorialProcess() {
  return (
    <section
      id="como-trabajamos"
    ...
    >
      <div className="max-w-3xl space-y-1">
        ...
        <p className="text-sm text-muted-foreground sm:text-base">
          Criterios editoriales públicos. No prometemos verificación diaria ni resultados de juego.
        </p>
      </div>
      ...
      <p className="mt-4 text-sm text-muted-foreground">
        Consulta la metodología completa en{" "}
        <Link
          href="/como-evaluamos"
