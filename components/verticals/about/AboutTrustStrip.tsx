...
export function AboutTrustStrip({ className }: { className?: string }) {
  return (
    <div
      role="note"
      className={cn(
    ...
    >
      ...
      <p className="min-w-0 flex-1 text-[0.8125rem] leading-snug text-muted-foreground sm:text-sm sm:leading-relaxed">
        Autores identificados, fechas del registro editorial y calificaciones como opinión de
        JugadaMax — no votos de usuarios.{" "}
        <Link
          href="/como-evaluamos"
