...
const RANKING: readonly RankingEntry[] = [
  {
    ...
    summary:
      "Registro con email y contraseña, política pública sin KYC y amplio catálogo cripto.",
  ...
  },
  {
    ...
    summary: "Slots, Originals, live casino y promociones para usuarios de criptomonedas.",
  ...
  },
  {
    ...
    summary:
      "Casino cripto orientado a Litecoin, email y contraseña y política pública sin KYC.",
