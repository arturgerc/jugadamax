...
> = {
  casino: {
    ...
    paymentBadges: ["Tarjetas", "E-wallets", "Cripto", "Sportsbook"],
    featureBullets: [
      "Casino, slots, live casino y juegos de mesa",
      "Sportsbook y freebets dentro de la misma cuenta",
      "Métodos fiat y cripto según país y cajero",
  ...
  sportsbook: {
    ...
    paymentBadges: ["Sportsbook", "Casino", "Tarjetas", "Cripto"],
    featureBullets: [
  ...
  review: {
    ...
    featureBullets: [
      ...
      "Métodos fiat y cripto según disponibilidad",
