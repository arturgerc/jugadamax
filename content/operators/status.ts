...
const OPERATOR_POLICIES: Record<string, OperatorPolicy> = {
  ...
  betsson: {
    ...
    affiliateAllowed: true,
    notes:
      "Outbound links resolved via BETSSON_MX_* constants. English homepage may present Betsson Mexico as a Mexico-facing fiat option with jurisdiction-aware copy.",
  },
  "1xbet": {
    id: "1xbet",
    name: "1xBet",
  ...
  codere: {
    ...
    allowedSurfaces: ["casinos-fiat", "apuestas", "reviews", "sitemap", "english-global"],
    ctaAllowed: false,
    affiliateAllowed: false,
    notes: "Codere pending partner — no external CTA; internal review only. English pages may show Mexico-market editorial reference cards.",
  },
  caliente: {
    id: "caliente",
    name: "Caliente",
    publicStatus: "pending-partner",
    allowedSurfaces: ["casinos-fiat", "reviews", "sitemap", "english-global"],
    ctaAllowed: false,
    affiliateAllowed: false,
    notes: "Caliente pending partner — no external CTA; editorial/internal only. English pages may show Mexico-market editorial reference cards.",
  },
  cryptocasino: {
    id: "cryptocasino",
