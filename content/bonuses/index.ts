...
export const bonuses: Bonus[] = [
  ...
  },
  {
    ...
    type: "welcome",
    terms:
      "Código JUGADAMAX. Las creatividades también muestran +2% para depósitos con criptomonedas y 50 FS por vincular Telegram. Depósito mínimo, wagering, juegos elegibles, vencimiento, límites y disponibilidad deben confirmarse en los términos oficiales.",
    active: true,
    product: "casino",
    market: "global",
    status: "active-variable",
